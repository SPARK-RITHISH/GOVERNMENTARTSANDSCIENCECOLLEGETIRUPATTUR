            ...
            <CardContent>
              <div className="pt-2">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="bg-gradient-to-br from-red-50 via-orange-50 to-pink-100 p-4 rounded-xl border border-red-200 shadow-sm hover:shadow-md transition-shadow duration-200">
                    <div className="flex items-center justify-between">
                ...
                <div className="mt-6">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2.5">
                    <div className="flex rounded-full h-2.5 overflow-hidden">
                      <div className="bg-gradient-to-r from-green-400 via-emerald-500 to-teal-500" style={{ width: `${stats.total > 0 ? (stats.present / stats.total) * 100 : 0}%` }}></div>
                      <div className="bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500" style={{ width: `${stats.total > 0 ? (stats.late / stats.total) * 100 : 0}%` }}></div>
                      <div className="bg-gradient-to-r from-blue-400 via-indigo-500 to-purple-500" style={{ width: `${stats.total > 0 ? (stats.excused / stats.total) * 100 : 0}%` }}></div>
                      <div className="bg-gradient-to-r from-red-400 via-pink-500 to-rose-500" style={{ width: `${stats.total > 0 ? (stats.absent / stats.total) * 100 : 0}%` }}></div>
                    </div>
                  </div>
                  
                  <div className="flex flex-wrap mt-3 text-xs gap-x-4">
                    <div className="flex items-center">
                      <span className="w-3 h-3 inline-block mr-1 rounded-full bg-gradient-to-r from-green-400 via-emerald-500 to-teal-500"></span>
                      <span className="text-gray-600">Present</span>
                    </div>
                    <div className="flex items-center">
                      <span className="w-3 h-3 inline-block mr-1 rounded-full bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500"></span>
                      <span className="text-gray-600">Late</span>
                    </div>
                    <div className="flex items-center">
                      <span className="w-3 h-3 inline-block mr-1 rounded-full bg-gradient-to-r from-blue-400 via-indigo-500 to-purple-500"></span>
                      <span className="text-gray-600">Excused</span>
                    </div>
                    <div className="flex items-center">
                      <span className="w-3 h-3 inline-block mr-1 rounded-full bg-gradient-to-r from-red-400 via-pink-500 to-rose-500"></span>
